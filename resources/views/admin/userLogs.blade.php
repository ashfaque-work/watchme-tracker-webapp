                                        ...
                                        <li class="tracked-item">
                                            <div
                                                ...
                                                <div class="duration-details">
                                                    <p class="duration mb-0"><span
                                                            class="duration">{{ $log['duration'] }}</span></p>
                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="put" id="addTimeForm">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="datetime-local" class="form-control" name="from_datetime"
                                        id="from_datetime" value="" readonly required>
                                    <label for="from_datetime">From</label>
                                </div>
                                <div class="form-floating mb-1">
                                    <input type="datetime-local" class="form-control" name="to_datetime"
                                        id="to_datetime" value="" readonly required>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div id="screenshotCarousel" class="carousel slide pointer-event" data-bs-ride="carousel">
                                ...
                                <a class="carousel-control-prev" href="#screenshotCarousel" role="button"
                                    data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#screenshotCarousel" role="button"
                                    data-bs-slide="next">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchLogs(selectedUserId, startDate, endDate) {
                var url =
                    `{{ route('admin.getUserLog') }}?userId=${selectedUserId}&start_date=${startDate}&end_date=${endDate}`;
                var hasEditUserLogPermission = @json(auth()->user()->can('edit_user_log'));
                                    ...
                                    <div
                                        ...
                                        <div class="screenshot-details screenshot-trigger col d-flex justify-content-end">
                                            ...
                                            <button class="btn btn-secondary-outline btn-lg p-1 px-2" data-bs-toggle="modal"
                                                ...
                                                <i class="mdi mdi-image-multiple mdi-18"></i>
